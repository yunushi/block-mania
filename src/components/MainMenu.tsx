    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center gap-12 max-w-lg w-full">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-8xl font-black italic tracking-tighter text-white drop-shadow-[0_0_20px_rgba(255,255,255,0.3)] animate-bounce-in">
            MENU
          </h1>
          <p className="text-slate-400 font-bold tracking-[0.2em] uppercase text-sm animate-fade-in">Block Blast Adventure</p>
        </div>

        {/* High Score */}
        <div className="px-10 py-4 bg-white/5 rounded-[2rem] border border-white/10 glass animate-scale-in">
          <p className="text-slate-400 text-xs font-black tracking-widest uppercase mb-1">Personal Best</p>
          <p className="text-4xl font-black text-white tabular-nums tracking-tighter italic">{highScore.toLocaleString()}</p>
        </div>
